...
public:
  ...
  enum OptionType_e
  {
    ...
    ICMPV6_OPT_MTU,
    ICMPV6_OPT_MPR_PARAMS,	//MG: MPR parameters option
    ICMPV6_OPT_MPR_ANNOUNCEMENT = 9	//MG: MPR announcement option
  };
...
typedef std::list<Ipv6Address> AddrList;	//list for storing node's mpr addresses
 typedef std::list<Ipv6Address>::const_iterator AddrListCI;	//const iterator

/**
 * \class Icmpv6OptionMprParams
 * \brief ICMPv6 ND++ MPR Parameters option.
 */
class Icmpv6OptionMprParams : public Icmpv6OptionHeader
{
public:

	 uint8_t m_willingness;
	  uint8_t m_linkCode;
	  AddrList m_NeighAddresses;

  /**
   * \brief Constructor.
   */
  Icmpv6OptionMprParams (uint8_t willingness = NeighInfo::WILL_DEFAULT, uint8_t link_code = (NeighInfo::NOT_NEIGH | NeighInfo::UNSPEC_LINK));

  /**
    * \brief copy Constructor.
    */
 //  Icmpv6OptionMprParams(const Icmpv6OptionMprParams &o);

  /**
   * \brief Destructor.
   */
  virtual ~Icmpv6OptionMprParams ();
  ...
  /**
   * \brief Insert neighbor address
   * \return the hardware address
   */
  void AddNeighbor (Ipv6Address addr);
...
private:
  u_int32_t m_reserved;

};


/**
 * \class Icmpv6OptionMprAnnouncement
 * \brief ICMPv6 ND++ MPR Announcement option.
 */
class Icmpv6OptionMprAnnouncement : public Icmpv6OptionHeader
{
public:

	AddrList m_MprAddresses;

  /**
   * \brief Constructor.
   */
	Icmpv6OptionMprAnnouncement();

	/**
	* \brief Destructor.
	*/
	virtual ~Icmpv6OptionMprAnnouncement ();
  ...
  /**
   * \brief Insert MPR address
   * \return the hardware address
   */
  void AddMPR (Ipv6Address addr);
...
private:
  ...
  u_int16_t m_reserved1;
  u_int32_t m_reserved2;
};

typedef std::list<Ipv6AddrRandomIDPair> AddrListWithIds;	//list for storing node's mpr addresses
typedef std::list<Ipv6AddrRandomIDPair>::const_iterator AddrListWithIdsCI;	//const iterator

/**
 * \class Icmpv6OptionMprParamsWithRandomIds
 * \brief ICMPv6 ND++ MPR Parameters option (sending addresses with random ids)
 */
class Icmpv6OptionMprParamsWithRandomIds : public Icmpv6OptionHeader
{
public:

	 uint8_t m_willingness;
	  uint8_t m_linkCode;
	  AddrListWithIds m_NeighAddresses;

  /**
   * \brief Constructor.
   */
  Icmpv6OptionMprParamsWithRandomIds (uint8_t willingness = NeighInfo::WILL_DEFAULT, uint8_t link_code = (NeighInfo::NOT_NEIGH | NeighInfo::UNSPEC_LINK));
 ...
 //  Icmpv6OptionMprParams(const Icmpv6OptionMprParams &o);
   ...
   * \brief Destructor.
   */
  virtual ~Icmpv6OptionMprParamsWithRandomIds ();
   ...
   * \return the hardware address
   */
  void AddNeighbor (Ipv6AddrRandomIDPair addr);
...
class Icmpv6OptionMprAnnWithRandomIds : public Icmpv6OptionHeader
{
public:

	AddrListWithIds m_MprAddresses;

  /**
   * \brief Constructor.
   */
	Icmpv6OptionMprAnnWithRandomIds();

	/**
	* \brief Destructor.
	*/
	virtual ~Icmpv6OptionMprAnnWithRandomIds ();
   ...
   * \return the hardware address
   */
  void AddMPR (Ipv6AddrRandomIDPair addr);
