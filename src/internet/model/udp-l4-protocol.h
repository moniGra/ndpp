...
public:
  ...
  /*//MG:added to allow passing ipv6 header as argument - body blank because it is not supposed to be used in this function
  virtual enum RxStatus Receive (Ptr<Packet> p, Ipv6Header ip, Ipv6Address const &src,
                                       Ipv6Address const &dst,
                                       Ptr<Ipv6Interface> incomingInterface){return IpL4Protocol::RX_OK;}
*/
  /**
