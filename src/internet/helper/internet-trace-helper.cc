...
//
/*void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (std::string prefix, Ptr<Icmpv6L4Protocol> icmpv6, uint32_t interface, bool explicitFilename)
{
  EnableAsciiIcmpv6Internal (Ptr<OutputStreamWrapper> (), prefix, icmpv6, interface, explicitFilename);
}*/
...
//
/*void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (Ptr<OutputStreamWrapper> stream, Ptr<Icmpv6L4Protocol> icmpv6, uint32_t interface)
{
  EnableAsciiIcmpv6Internal (stream, std::string (), icmpv6, interface, false);
}*/
...
//
/*void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (std::string prefix, std::string icmpv6Name, uint32_t interface, bool explicitFilename)
{
  EnableAsciiIcmpv6Impl (Ptr<OutputStreamWrapper> (), prefix, icmpv6Name, interface, explicitFilename);
}*/
...
/*
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (Ptr<OutputStreamWrapper> stream, std::string icmpv6Name, uint32_t interface)
{
  EnableAsciiIcmpv6Impl (stream, std::string (), icmpv6Name, interface, false);
}
*/
...
//
/*void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6Impl (
  Ptr<OutputStreamWrapper> stream,
  std::string prefix,
  std::string icmpv6Name,
  uint32_t interface,
  bool explicitFilename)
{
  Ptr<Icmpv6L4Protocol> icmpv6 = Names::Find<Icmpv6L4Protocol> (icmpv6Name);
  EnableAsciiIcmpv6Internal (stream, prefix, icmpv6, interface, explicitFilename);
}*/
...
//
/*void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (std::string prefix, Icmpv6InterfaceContainer c)
{
  EnableAsciiIcmpv6Impl (Ptr<OutputStreamWrapper> (), prefix, c);
}*/
...
/*
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (Ptr<OutputStreamWrapper> stream, Icmpv6InterfaceContainer c)
{
  EnableAsciiIcmpv6Impl (stream, std::string (), c);
}
*/
...
//
/*void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6Impl (Ptr<OutputStreamWrapper> stream, std::string prefix, Icmpv6InterfaceContainer c)
{
  for (Icmpv6InterfaceContainer::Iterator i = c.Begin (); i != c.End (); ++i)
    {
      std::pair<Ptr<Icmpv6L4Protocol>, uint32_t> pair = *i;
      EnableAsciiIcmpv6Internal (stream, prefix, pair.first, pair.second, false);
    }
}*/
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (std::string prefix, NodeContainer n)
{
  EnableAsciiIcmpv6Impl (Ptr<OutputStreamWrapper> (), prefix, n);
}
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (Ptr<OutputStreamWrapper> stream, NodeContainer n)
{
  EnableAsciiIcmpv6Impl (stream, std::string (), n);
}
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6All (std::string prefix)
{
  EnableAsciiIcmpv6Impl (Ptr<OutputStreamWrapper> (), prefix, NodeContainer::GetGlobal ());
}
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6All ()
{
  EnableAsciiIcmpv6Impl (NodeContainer::GetGlobal ());
}
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6All (std::string prefix, std::string sufix)
{
  EnableAsciiIcmpv6Impl (Ptr<OutputStreamWrapper> (), prefix+"-"+sufix, NodeContainer::GetGlobal ());
}
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6All (Ptr<OutputStreamWrapper> stream)
{
  EnableAsciiIcmpv6Impl (stream, std::string (), NodeContainer::GetGlobal ());
}
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6Impl (Ptr<OutputStreamWrapper> stream, std::string prefix, NodeContainer n)
{
	for (NodeContainer::Iterator i = n.Begin (); i != n.End (); ++i)
	{
	  Ptr<Node> node = *i;
	  Ptr<Icmpv6L4Protocol> icmpv6 = node->GetObject<Icmpv6L4Protocol>();
	 // Ptr<Icmpv6L4Protocol> icmpv6 = node->GetObject<Ipv6L3Protocol> ()->GetIcmpv6();
	  if (icmpv6)
	  {
			  EnableAsciiIcmpv6Internal (stream, prefix, icmpv6, false);
	  }
	}
}
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6Impl (NodeContainer n)
{
	for (NodeContainer::Iterator i = n.Begin (); i != n.End (); ++i)
	{
	  Ptr<Node> node = *i;
	 ...
	 // Ptr<Icmpv6L4Protocol> icmpv6 = node->GetObject<Ipv6L3Protocol> ()->GetIcmpv6();
	  if (icmpv6)
		  EnableAsciiIcmpv6Internal (icmpv6, false);
	}
}
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (Ptr<OutputStreamWrapper> stream, uint32_t nodeid)
{
  EnableAsciiIcmpv6Impl (stream, std::string (), nodeid, false);
}
...
//
void
AsciiTraceHelperForIcmpv6::EnableAsciiIcmpv6 (std::string prefix, uint32_t nodeid, bool explicitFilename)
{
  EnableAsciiIcmpv6Impl (Ptr<OutputStreamWrapper> (), prefix, nodeid, explicitFilename);
}
  ...
  for (NodeContainer::Iterator i = n.Begin (); i != n.End (); ++i)
    {
      ...
      if (icmpv6)
		{
		  EnableAsciiIcmpv6Internal (stream, prefix, icmpv6, explicitFilename);
		}
      return;
    }
}
